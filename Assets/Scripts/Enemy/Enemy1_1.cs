...
public class Enemy1_1 : Enemy {
    ...
    void FireProjectile()
    {
        if (Time.time > firingTimer)
        {
            ...
            GameManager.Instance.poolManager.ReuseObject(GameManager.Instance.enemyManager.enemyProjectiles[0], projectileSpawnPostion.position, Quaternion.identity);
        }
    }

...
public class Enemy1_3 : Enemy
{
    ...
    public Transform projectileThreeSpawnPostion;
    ...
    void FireProjectiles()
    {
        if (Time.time > firingTimer)
        {
            ...
            GameManager.Instance.poolManager.ReuseObject(GameManager.Instance.enemyManager.enemyProjectiles[0], 
                projectileOneSpawnPostion.position, 
                Quaternion.Euler(new Vector3(0.0f, 0.0f, -25f)));
            GameManager.Instance.poolManager.ReuseObject(GameManager.Instance.enemyManager.enemyProjectiles[0], 
                projectileTwoSpawnPostion.position,
                Quaternion.Euler(new Vector3(0.0f, 0.0f, 25f)));
            GameManager.Instance.poolManager.ReuseObject(GameManager.Instance.enemyManager.enemyProjectiles[0], projectileThreeSpawnPostion.position, Quaternion.identity);
        }
    }
